...
const listkey = ["skyBot", "Skyw4lkeR77"];
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'YOUR_APIKEY') return res.json(loghandler.invalidKey)
...
router.get('/cewe/vietnam', async (req, res, next) => {
	...
	if (apikeyInput != 'YOUR_APIKEY')  return res.json(loghandler.invalidKey)
